...
function App({ data }: { data: any }) {
    return (
        <>
            <div className="bg-gray-900 px-20 py-12 pb-12">
                <h1 className="text-gradient font-bold text-2xl md:text-5xl text-center text-gray-100 pb-4 px-4">
                ...
                <div className="text-slate-300 mx-auto md:w-full lg:w-6/12 text-justify pb-8 px-4">
                ...
                <div className="text-center">
                    <a
                        className="text-slate-700 bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-blue-300
            ...
            <section className="bg-slate-300 lg:px-32 xl:px-52 p-16 block-gradient">
                <Comparison />
